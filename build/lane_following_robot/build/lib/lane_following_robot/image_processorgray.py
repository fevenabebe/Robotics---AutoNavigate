...
class DualLaneDetector(Node):
    def __init__(self):
        ...
        # HSV thresholds for green lane detection (adjusted to match Gazebo's green)
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            for contour in contours:
                ...
                if self.min_contour_area < area:
                    x, y, w, h = cv2.boundingRect(contour)
                    if w < self.max_lane_width:
                        lane_contours.append(contour)
            ...
            if len(lane_contours) == 2:
                ...
                if M["m00"] != 0:
                    ...
                    cv2.circle(output_img, (cx, int(M["m01"] / M["m00"])), 5, (0, 0, 255), -1)
